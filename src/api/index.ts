...
// Each domain lives in its own file (./auth, ./players, …) for maintainability.
...
export type { CreateTournamentPayload, RegistrationRow } from './tournaments';
export { matchesApi }       from './matches';
export { leaderboardApi }   from './leaderboard';
export { feedApi, REACTIONS, toReactionInt } from './feed';
export type { ReactionKind } from './feed';
export { marketplaceApi }   from './marketplace';
export { privateGroupsApi } from './privateGroups';
export { chatApi }          from './chat';
export type { ChatParticipantDto, ChatRoomDto, ChatMessageDto } from './chat';
...
export type { AdminStats, AdminUser, AdminPayment } from './admin';
